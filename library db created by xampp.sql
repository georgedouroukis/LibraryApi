...
ALTER TABLE `genre`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parent_genre` (`parent_genre`);
...
ALTER TABLE `book_authors`
  ...
  ADD CONSTRAINT `book_author_id` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`);
...
--
ALTER TABLE `genre`
  ADD CONSTRAINT `parent_genre` FOREIGN KEY (`parent_genre`) REFERENCES `genre` (`id`);
COMMIT;
